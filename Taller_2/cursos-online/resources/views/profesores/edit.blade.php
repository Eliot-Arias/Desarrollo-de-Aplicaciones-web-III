                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"
                                        ...
                                        name="nombre_apellido" id="nombre_apellido" placeholder="Name"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control @error('profesion') is-invalid @enderror" name="profesion" id="profesion"
                                        placeholder="Name" value="{{ old('profesion', $profesor->profesion) }}">
                                    @error('profesion')
                                        <span id="profesion" class="invalid-feedback" role="alert"> {{ $message }}
                                        </span>
                                    @enderror
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="grado_academico"
                                        id="grado_academico"
                                        placeholder="Name"value="{{ old('grado_academico', $profesor->grado_academico) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="telefono" id="telefono"
                                        placeholder="Name" value="{{ old('telefono', $profesor->telefono) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
